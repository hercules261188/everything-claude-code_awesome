...
| Field | Evidence |
| --- | --- |
| Upstream main | `e7a7b2aaa33c0657cad9db3fa2ced0e636cd0f8c` |
...
| Owner approval packet | Added the final human decision sheet for release, package, plugin, video, billing, social, and outbound approvals |

## Release And Growth Evidence

| Gate | Command | Result |
| --- | --- | --- |
| Release-surface tests | `node tests/docs/ecc2-release-surface.test.js` | 26 passed, 0 failed |
...
| Full local suite | `node tests/run-all.js` | 2548 passed, 0 failed |
...
`e7a7b2aaa33c0657cad9db3fa2ced0e636cd0f8c`. The remaining video work is
